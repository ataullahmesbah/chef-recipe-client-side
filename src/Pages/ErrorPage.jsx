...
function ErrorPage() {
  return (
    <div className="flex flex-col items-center justify-center h-screen ">
      ...
      <img src="https://img.freepik.com/vector-premium/ilustracion-concepto-error-404-pagina-no-encontrada_270158-294.jpg?w=826" alt="Error" className="object-cover" />
